...
def delete_unnecessary_conversation_message_fields(message: ConversationMessageUnion) -> str:
...
def format_conversation_history_for_prompt(conversation_history: tuple[ConversationMessageUnion, ...]) -> str:
...
def load_conversation_history(conversation_file_path: Path) -> tuple[ConversationMessageUnion, ...]:
...
def parse_conversation_history(conversation_str: str) -> tuple[ConversationMessageUnion, ...]:
