...
def compute_file_format_style(
    file_path: str, subrepo_context_matchers: SubrepoContextMatchers, exclusions: FilenamePattern | None = None
) -> ContextFormatStyle:
...
def format_subrepo_context(
    ...
    repo_context_str = build_context_from_filecontexts(
        repo_contents_tuple, model_config, tokens_to_reserve, template, path_to_format_style
    )
